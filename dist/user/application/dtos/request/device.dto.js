...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'android', enum: ['android', 'ios', 'web'] }),
    (0, class_validator_1.IsEnum)(['android', 'ios', 'web']),
    __metadata("design:type", String)
], RegisterPushTokenDto.prototype, "platform", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'fcm-XXXX' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], RegisterPushTokenDto.prototype, "pushToken", void 0);
